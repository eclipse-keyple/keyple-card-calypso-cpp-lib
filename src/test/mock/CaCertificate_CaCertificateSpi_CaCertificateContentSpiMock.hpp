...
class CaCertificate_CaCertificateSpi_CaCertificateContentSpiMock final
: public CaCertificateContentSpi,
  public CaCertificate,
  public CaCertificateSpi {
public:
    CaCertificate_CaCertificateSpi_CaCertificateContentSpiMock() = default;

...
class PcaCertificate_PcaCertificateSpi_CaCertificateContentSpiMock final
: public CaCertificateContentSpi,
  public PcaCertificate,
  public PcaCertificateSpi {
public:
    PcaCertificate_PcaCertificateSpi_CaCertificateContentSpiMock() = default;

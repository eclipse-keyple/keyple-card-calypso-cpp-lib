...
CalypsoCardClass::CalypsoCardClass(std::uint8_t cla)
: mCla(cla)
{

}

CalypsoCardClass::CalypsoCardClass(const CalypsoCardClass& o)
: CalypsoCardClass(o.mCla) {}
...
bool
CalypsoCardClass::operator==(const CalypsoCardClass& o) const
{
    return mCla == o.mCla;
}

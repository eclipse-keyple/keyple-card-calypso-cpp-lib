...
const std::map<int, const std::shared_ptr<Command::StatusProperties>>
    CommandRehabilitate::STATUS_TABLE = [] {
...
void
CommandRehabilitate::finalizeRequest()
{
    encryptRequestAndUpdateTerminalSessionMacIfNeeded();
}

const std::map<int, const std::shared_ptr<Command::StatusProperties>>&
CommandRehabilitate::getStatusTable() const
{
    return STATUS_TABLE;
}

bool
CommandRehabilitate::isCryptoServiceRequiredToFinalizeRequest() const
{
    return getCommandContext()->isEncryptionActive();
}

bool
CommandRehabilitate::synchronizeCryptoServiceBeforeCardProcessing()
{
...
void
CommandRehabilitate::parseResponse(

...
/**
 * Indicates that the input user data do not allow to build a syntactically
 * correct command (e.g. SFI too large, record number out of bounds,...).
 *
 * @since 2.0.0
 */
class KEYPLECARDCALYPSO_API CardIllegalArgumentException final

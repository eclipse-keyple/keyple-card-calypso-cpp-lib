 ...
 */
template <typename T>
class KEYPLECARDCALYPSO_API TransactionManagerAdapter
: public virtual TransactionManager<T> {
public:
    /**
...
template <typename T>
class KEYPLECARDCALYPSO_API TransactionManagerAdapter<TransactionManager<T>> {
public:
};

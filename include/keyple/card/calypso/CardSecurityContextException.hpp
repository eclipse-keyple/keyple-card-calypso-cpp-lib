...
/**
 * Indicates that the security conditions are not fulfilled (e.g. no session,
 * wrong key).
 *
 * @since 2.0.0
 */
class CardSecurityContextException final : public CardCommandException {
public:
    /**

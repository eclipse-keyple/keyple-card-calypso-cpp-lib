...
class KEYPLECARDCALYPSO_API DtoAdapters final {
public:
    /**
     ...
     * @since 2.0.0
     */
    class KEYPLECARDCALYPSO_API ApduRequestAdapter final
     ...
     * @since 2.0.0
     */
    class KEYPLECARDCALYPSO_API CardRequestAdapter final
     ...
     * @since 2.0.0
     */
    class KEYPLECARDCALYPSO_API CardSelectionRequestAdapter final
     ...
     * @since 2.1.0
     */
    class KEYPLECARDCALYPSO_API SearchCommandDataAdapter final
    : public SearchCommandData {
    public:
        /**
         * Constructor.
         */
     ...
     * @since 2.3.1
     */
    class KEYPLECARDCALYPSO_API SvCommandSecurityDataApiAdapter final
     ...
     * @since 2.0.0
     */
    class KEYPLECARDCALYPSO_API SvDebitLogRecordAdapter final
    : public SvDebitLogRecord {
    public:
        /**
         * Constructor
         *
     ...
     * @since 2.0.0
     */
    class KEYPLECARDCALYPSO_API SvLoadLogRecordAdapter final
    : public SvLoadLogRecord {
    public:
        /**
         * Constructor
         *
     ...
     * @since 2.3.2
     */
    class KEYPLECARDCALYPSO_API CommandContextDto final {
    public:
        /**
         * Constructor.
         *
     ...
     * @since 2.3.2
     */
    class KEYPLECARDCALYPSO_API TransactionContextDto final {
    public:
        /**
